...
df_loom_low_freezer = pd.DataFrame(index = index, columns = columns)
for rat in freeze_loom:
    ...
    elif ('14' in rat) | ('16' in rat) |('21' in rat) |('22' in rat) |('47' in rat) |('50' in rat) |('54' in rat) |('57' in rat) | ('time' in rat):   
        df_loom_low_freezer = pd.concat([df_loom_low_freezer, animal], axis=1, sort = True)
...
#%%
shock_15_sec = df_loom_low_freezer.groupby(np.arange(len(df_loom_low_freezer))//15).mean()
